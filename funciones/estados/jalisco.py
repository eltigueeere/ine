...
def excel02():        
    ...
    ('CI', math.floor(sumaCol['CI_01_Jalisco']),numerosLetras.numero_a_letras(math.floor(sumaCol['CI_01_Jalisco']))),
...
def excel03():    
    ...
    (
        'CI', math.floor(sumaColExcel01Excel01['CI_01_Jalisco']), numerosLetras.numero_a_letras(sumaColExcel01Excel01['CI_01_Jalisco'])
    ),
    (
