...
can.drawString(400, 158, tb3[3][2]) 
can.drawString(590, 158, str(tb3[3][1]))  
can.drawString(400, 145, tb3[3][2]) 
can.drawString(590, 145, str(tb3[3][1]))  
can.drawString(400, 128, tb3[3][2]) 
can.drawString(590, 128, str(tb3[3][1]))  
can.drawString(400, 111, tb3[3][2]) 
can.drawString(590, 111, str(tb3[3][1]))  
can.drawString(400, 93, tb3[3][2]) 
can.drawString(590, 93, str(tb3[3][1]))  
can.drawString(400, 78, tb3[3][2]) 
can.drawString(590, 78, str(tb3[3][1]))  
can.save()
