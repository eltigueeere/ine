...
can.drawString(400, 120, tb3[6][2]) 
can.drawString(590, 120, str(tb3[6][1]))  
can.drawString(400, 105, tb3[7][2]) 
can.drawString(590, 105, str(tb3[7][1]))  
can.drawString(400, 90, tb3[8][2]) 
can.drawString(590, 90, str(tb3[8][1]))  
can.drawString(400, 75, tb3[9][2]) 
can.drawString(590, 75, str(tb3[9][1]))  
can.drawString(400, 58, tb3[10][2]) 
can.drawString(590, 58, str(tb3[10][1]))  
can.drawString(400, 39, tb3[11][2]) 
can.drawString(590, 39, str(tb3[11][1]))  
can.save()
