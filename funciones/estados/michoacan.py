...
can.drawString(400, 129, tb3[5][2]) 
can.drawString(590, 129, str(tb3[5][1]))  
can.drawString(400, 114, tb3[6][2]) 
can.drawString(590, 114, str(tb3[6][1]))  
can.drawString(400, 98, tb3[7][2]) 
can.drawString(590, 98, str(tb3[7][1]))  
can.drawString(400, 82, tb3[8][2]) 
can.drawString(590, 82, str(tb3[8][1]))  
can.save()
