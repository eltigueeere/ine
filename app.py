...
def index():    
    ...
    def excel01():
        ...
        datos=(
        ('PAN', math.floor(sumaColExcel01['PAN'])),
        ('PRI', math.floor(sumaColExcel01['PRI'])),
        ('PRD', math.floor(sumaColExcel01['PRD'])),
        ('PT', math.floor(sumaColExcel01['PT'])),
        ('VERDE', math.floor(sumaColExcel01['VERDE'])),
        ('MOVIMIENTO CIUDADANO', math.floor(sumaColExcel01['MOVIMIENTO_CIUDADANO'])),
        ('MORENA', math.floor(sumaColExcel01['MORENA'])),
        ('NUEVA ALIANZA', math.floor(sumaColExcel01['NUEVA_ALIANZA'])),
        ('PAZ', math.floor(sumaColExcel01['PAZ'])),
        ('DIGNIDAD', math.floor(sumaColExcel01['DIGNIDAD'])),
        ('PP', math.floor(sumaColExcel01['PP'])),
        ('LA FAMILIA', math.floor(sumaColExcel01['LA_FAMILIA'])),
        ('PES', math.floor(sumaColExcel01['PES'])),
        ('RSP', math.floor(sumaColExcel01['RSP'])),
        ('FUERZA POR MEXICO', math.floor(sumaColExcel01['FUERZA_POR_MEXICO'])),
        ('PAN_PRI_PRD', math.floor(sumaColExcel01['PAN_PRI_PRD'])),
        ('PAN_PRI', math.floor(sumaColExcel01['PAN_PRI'])),
        ('PAN_PRD', math.floor(sumaColExcel01['PAN_PRD'])),
        ('PRI_PRD', math.floor(sumaColExcel01['PRI_PRD'])),
        ('PT_VERDE_MORENA_NUEVA_ALIANZA', math.floor(sumaColExcel01['PT_VERDE_MORENA_NUEVA_ALIANZA'])),
        ('PT_VERDE_MORENA', math.floor(sumaColExcel01['PT_VERDE_MORENA'])),
        ('PT_VERDE_NUEVA_ALIANZA', math.floor(sumaColExcel01['PT_VERDE_NUEVA_ALIANZA'])),
        ('PT_MORENA_NUEVA_ALIANZA', math.floor(sumaColExcel01['PT_MORENA_NUEVA_ALIANZA'])),
        ('VERDE_MORENA_NUEVA_ALIANZA', math.floor(sumaColExcel01['VERDE_MORENA_NUEVA_ALIANZA'])),
        ('PT_VERDE', math.floor(sumaColExcel01['PT_VERDE'])),
        ('PT_MORENA', math.floor(sumaColExcel01['PT_MORENA'])),
        ('PT_NUEVA_ALIANZA', math.floor(sumaColExcel01['PT_NUEVA_ALIANZA'])),
        ('VERDE_MORENA', math.floor(sumaColExcel01['VERDE_MORENA'])),
        ('VERDE_NUEVA_ALIANZA', math.floor(sumaColExcel01['VERDE_NUEVA_ALIANZA'])),
        ('MORENA_NUEVA_ALIANZA', math.floor(sumaColExcel01['MORENA_NUEVA_ALIANZA'])),
        ('CANDIDATOS_NO_REGISTRADOS', math.floor(sumaColExcel01['CANDIDATOS_NO_REGISTRADOS'])),
        ('VOTOS_NULOS', math.floor(sumaColExcel01['VOTOS_NULOS'])),
        ('TOTAL', totalDefExc))
    ...
    def excel02():
        ...
        datos=[
        ('PAN', math.floor(sumaCol['PAN'])),
        ('PRI', math.floor(sumaCol['PRI'])),
        ('PRD', math.floor(sumaCol['PRD'])),
        ('PT', math.floor(sumaCol['PT'])),
        ('VERDE', math.floor(sumaCol['VERDE'])),
        ('MOVIMIENTO CIUDADANO', math.floor(sumaCol['MOVIMIENTO_CIUDADANO'])),
        ('MORENA', math.floor(sumaCol['MORENA'])),
        ('NUEVA ALIANZA', math.floor(sumaCol['NUEVA_ALIANZA'])),
        ('PAZ', math.floor(sumaCol['PAZ'])),
        ('DIGNIDAD', math.floor(sumaCol['DIGNIDAD'])),
        ('PP', math.floor(sumaCol['PP'])),
        ('LA FAMILIA', math.floor(sumaCol['LA_FAMILIA'])),
        ('PES', math.floor(sumaCol['PES'])),
        ('RSP', math.floor(sumaCol['RSP'])),
        ('FUERZA POR MEXICO', math.floor(sumaCol['FUERZA_POR_MEXICO'])),
        ('CANDIDATOS_NO_REGISTRADOS', math.floor(sumaCol['CANDIDATOS_NO_REGISTRADOS'])),
        ('VOTOS_NULOS', math.floor(sumaCol['VOTOS_NULOS'])),
        ('TOTAL', totalDefExc)
        ]
        #rb = open_workbook('Zacatecas.xls',formatting_info=True)
        #wb = copy(rb)
...
#    excel01()
    ############excel02()
    return render_template("pdf/pdf.html", lalos = excel01(), lalos2 = excel02(), dia = dia, hora=hora )    
...
#    excel01()
    ############excel02()
    return render_template("pdf/pdf2.html", lalos = excel02(), dia = dia, hora=hora )
